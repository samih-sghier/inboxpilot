...
### Email Integration
1. Go to **Connect Accounts** tab.  
2. Select **Connect Email**.  
3. Follow the authentication process for Gmail or Outlook.  
4. Choose your **Send Mode**:  
   - **Send Automatically**: Emails are sent automatically after being drafted.  
   - **Review Before Sending**: Drafts are created for each email, allowing you to review and send manually.
